...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"menuCoreDataModel" withExtension:@"momd"];  //@"momd"
    
    NSLog(@"bundle Path %@", [[NSBundle mainBundle] bundlePath]);
    NSLog(@"url path %@", [modelURL path]);
    
    _managedObjectModel = [[NSManagedObjectModel alloc] initWithContentsOfURL:modelURL];
    
    NSArray *arrayEntities = [_managedObjectModel entities];
    for (NSEntityDescription *entity in arrayEntities) {
        NSLog(@"entity name in model %@", [entity name]);
    }
